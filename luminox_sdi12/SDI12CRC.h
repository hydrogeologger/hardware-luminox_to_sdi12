...
#define SDI12CRC_ASCII_SIZE 4 // Size char array to store ASCII representation of CRC-16, includes null terminator
...
class SDI12CRC {
  ...
  public:
    ...
    template <typename T> void Add(T value); // Adds calculated CRC to existing, DO NOT use for string CRC calcuation
};


/**
 * @brief Adds the CRC-16 calculation of int types to existing, DO NOT use for string CRC calculation.
 * 
 ...
 */
template <typename T> void SDI12CRC::Add(T value) {
